...
const PrivacyPolicyPage = () => {
  return (
    <Layout
      title="Privacy Policy - PrimeEdge by Involv"
      description="Privacy policy for PrimeEdge EGM optimization platform by Involv."
    >
        ...
        <div className="bg-gray-900/50 border border-white/10 rounded-2xl p-8">
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-300 mb-6">
              This privacy policy will describe how Involv collects, uses, and protects your information when you use PrimeEdge.
            </p>
